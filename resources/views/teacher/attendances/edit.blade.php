<x-app-layout>
    ...
    <div class="space-y-5">
        ...
        <div class="rounded-lg bg-white p-6 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-stone-300">
            <form action="{{ route('teacher.attendances.update', $session) }}" method="POST" class="space-y-6">
                @csrf @method('PUT')
                <input type="hidden" name="teaching_assignment_id" value="{{ $session->teaching_assignment_id }}">
