    ...
    <div class="space-y-5">
        ...
        @else
            ...
            <div class="flex items-center justify-between">
                <div></div>
                <a href="{{ route('homeroom.attendances.create') }}"
            ...
            <div class="rounded-lg bg-white p-6 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-stone-300">
                <form method="GET" action="{{ route('homeroom.attendances.index') }}" class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                    <div>
