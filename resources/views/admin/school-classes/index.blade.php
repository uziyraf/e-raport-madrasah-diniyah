<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-bold text-teal-950">Kelas</h2>
    </x-slot>
                        ...
                        <tr>
                            ...
                            <td class="border-t border-stone-300 px-6 py-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="{{ route('admin.school-classes.destroy', $class) }}" method="POST" onsubmit="return confirm('Nonaktifkan kelas ini?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
