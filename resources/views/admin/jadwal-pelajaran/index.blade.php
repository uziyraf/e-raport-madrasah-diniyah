<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-bold text-teal-950">Jadwal Pelajaran</h2>
    </x-slot>
    ...
    <div class="space-y-5">
        ...
        <div class="rounded-lg bg-white p-4 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-stone-300">
            <form method="GET" action="{{ route('admin.jadwal-pelajaran.index') }}" class="grid grid-cols-2 gap-4 md:grid-cols-6">
                <div>
        ...
        <div class="overflow-hidden rounded-lg bg-white outline outline-1 outline-offset-[-1px] outline-stone-300">
            <table class="min-w-full divide-y divide-stone-300">
                ...
                <tbody class="divide-y divide-stone-300">
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="px-6 py-10 text-center text-sm text-neutral-500">Belum ada data jadwal pelajaran.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
