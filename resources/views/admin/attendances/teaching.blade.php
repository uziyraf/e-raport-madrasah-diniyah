    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-bold text-teal-950">
                Rekap Absensi {{ $teachingAssignment->subject->name }} &mdash; {{ $schoolClass->level->name }} {{ $schoolClass->name }}
            </h2>
        </div>
    </x-slot>
    ...
    <div class="space-y-5">
        <div class="rounded-lg bg-white p-6 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-stone-300">
            <div class="text-sm text-neutral-600">
                ...
                &mdash; Fan/Mapel: <span class="font-semibold text-teal-950">{{ $teachingAssignment->subject->name }}</span>
                &mdash; Guru: <span class="font-semibold text-teal-950">{{ $teachingAssignment->teacher->name }}</span>
            </div>
        </div>
